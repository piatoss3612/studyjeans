...
// get study of guild
func (svc *serviceImpl) GetStudy(ctx context.Context, guildID string) (*models.Study, error) {
...
func (svc *serviceImpl) GetOngoingRound(ctx context.Context, guildID string) (*models.Round, error) {
	defer svc.mtx.Unlock()
	svc.mtx.Lock()
	...
	return res.(*models.Round), nil
}

// get all rounds of study of guild
func (svc *serviceImpl) GetRounds(ctx context.Context, guildID string) ([]*models.Round, error) {
	defer svc.mtx.Unlock()
	svc.mtx.Lock()
